    ...
    $.kc.fab = function(el, links, options){
        ...
        base.init = function(){
            ...
            if (base.links.length > 0){
                ...
                main_btn_dom = "<button onclick='GoToCreateRequest()' data-link-href='"+((main_btn.url)?main_btn.url:"")+"' data-link-target='"+((main_btn.target)?main_btn.target:"")+"' class='kc_fab_main_btn' style='"+bg_color_style+"'><span style='"+color_style+"'>"+main_btn.icon+"</span></button>";
                //main_btn_dom = "<a onclick='GoToCreateRequest()' data-link-href='"+((main_btn.url)?main_btn.url:"")+"' data-link-target='"+((main_btn.target)?main_btn.target:"")+"' class='floating-button' style='margin-bottom: 45px;'><i class='fa fa-plus'></i></a>";
