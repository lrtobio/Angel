    ...
    window.Framework7 = function (params) {
        ...
        ************   Smart Select   ************
        ...
        app.smartSelectOpen = function (smartSelect, reLayout) {
            ...
            var option, optionHasMedia, optionPrice, optionImage, optionIcon, optionGroup, optionGroupLabel, optionPreviousGroup, optionIsLabel, previousGroup, optionColor, optionClassName, optionData;
            for (var i = 0; i < select.length; i++) {
                option = $(select[i]);
                optionData = option.dataset();
                optionPrice = optionData.optionPrice || $selectData.optionPrice || smartSelectData.optionPrice;
                        ...
                        '{{#if image}}' +
                            ...
                            '<table width="100%">' +
                                '<tr>' +
                                    '<td width="50px">' +
                                        '{{#if hasMedia}}' +
                                        '<div class="item-media"   onclick="OpenViewPackage(\'{{image}}\')">' +
                                    ...
                                    '<td width="100%">' +
                                        ...
                                        '<div class="item-inner">' +
                                        '<div class="item-title{{#if color}} color-{{color}}{{/if}}">{{text}}' + '{{#if price}}<div class="price-tag">{{price}}</div>{{/if}}' + '</div>' +
                                        '</div>' +
                                        '{{/if}}' +
                                        '</label>' +
                                    '</td>' +
